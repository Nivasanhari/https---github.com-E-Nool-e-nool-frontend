...
export const CardsList = () => {
    return (
        ...
        <div class="grid gap-8 grid-cols-1 sm:gap-12   xl:gap-16 ">
            <div className="border border-[#E4E4E4] rounded-[21px] bg-white p-5 flex flex-col md:flex-row">
                <div className="md:w-56">
                    <Image className="rounded  w-56 object-cover object-center my-auto" src={TrendingReads1} alt="content" />
                </div>
                <div className="flex flex-col justify-between  md:px-6  w-full">
                    <div className="h-full">
                        <div className="flex lg:flex-row flex-col">
                        <h2 className="text-3xl text-[#1A6270] font-graphikBold  w-full">King of Battle and Blood</h2>
