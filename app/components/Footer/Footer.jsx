...
const Footer = () => {
    ...
    return (
        <footer className="w-auto  bg-transparent footer_bg ">
        
            <div className="  items-end md-px-24 pt-72 h-1/2 relative -bottom-1 container lg:pt-96 mx-auto">
                    ...
                    <div className="flex flex-wrap md:text-left text-center order-first">
                        <div className="lg:w-[32%]  w-full   px-4 mr-5  md:mb-10 ">
                            ...
                            <div className="items-center mx-auto mt-10 space-y-5 max-w-screen-sm sm:flex sm:space-y-0">
                                <div className="relative w-full h-f1">
                                    ...
                                    <input className="block py-4 pl-10 w-full text-gray-900 bg-gray-50  border border-gray-300 sm:rounded-none " placeholder="Enter your email" type="email" id="email" required=""/>
                                </div>
                                <div>
                                    <button type="submit" className="py-[17px] px-5 w-full  font-medium text-center text-white cursor-pointer bg-[#7CC9B5]  ">Subscribe</button>
                                </div>
                            </div>
                            
                            <div className="mx-auto my-5
                             max-w-screen-sm text-xs text-left text-white newsletter-form-footer dark:text-gray-300">By signing up, you agree to the <a href="#" className="font-medium text-primary-600 dark:text-primary-500 hover:underline"> Privacy Policy</a>.</div>
                        ...
                        <div className="lg:w-auto md:w-1/2  w-full px-8 xl:px-14 lg:px-10">
                            ...
                            <nav className="list-none mb-10 space-y-2">
                                <li>
                                    <a className="text-white hover:text-blueGray-800 font-semibold block pb-2 text-xs"
                                        href="#">Contact Us</a>
                                </li>
                                <li>
                                    <a className="text-white hover:text-blueGray-800 font-semibold block pb-2 text-xs"
