...
const Footer = () => {
  ...
  return (
    <footer className="w-full  absolute bg-transparent">
      <Image
        src={footerbg}
        alt="Background"
      ...
      <div className="  items-end md-px-24 relative  container pt-96 mx-auto">
        <div className="container px-5 py-10 mx-auto">
          <div className="flex flex-wrap md:text-left text-center order-first">
            <div className="lg:w-[32%]  w-full   px-4 md:mb-10 ">
              ...
              <div
                className="mx-auto my-5
                             max-w-screen-sm text-sm text-left text-white newsletter-form-footer dark:text-gray-300"
              >
            ...
            <div className="lg:w-[17%] md:w-1/2  w-full px-4">
      ...
      <table className="md:visible  absolute bottom-10 border-collapse border border-slate-400 w-full table-fixed">
        <tbody>
          <tr>
