...
export default function Pricing() {
  ...
  return (
      <section className=" w-full  mt-20  md:mb-96 sm:pb-0  ">
          <Image className=" hidden md:block absolute  left-10 mt-20 w-3/4" src={aboutobject} alt="" />
          <Image className=" hidden md:block absolute w-16 right-0 mt-20 transform -scale-x-100" src={Leaf1} alt="" />
