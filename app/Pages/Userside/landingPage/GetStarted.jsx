    ...
    <div className="md:container md:mx-auto flex pt-24 md:flex-row flex-col items-center">
      <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 md:items-center">
        <Image className="object-cover object-center rounded" alt="hero" src={gettingStarted} />
          ...
          <div className="relative lg:w-full md:w-1/2 w-5/6 lg:flex-grow lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left mt-7 text-center">
            <h1 className="text-4xl font-bold md:mt-36 text-white">Become an Enool Publisher Partner</h1>
            ...
            <Image className="sm:invisible lg:visible lg:block absolute bottom-0 right-0 object-cover object-center rounded" alt="hero" src={gettingStarted1} />
          </div>
