...
export default function BrowseCategories() {
    return (
        <section className="w-full">
            <Image className=" hidden lg:block absolute z-0   md:w-28 mt-28" src={Leaf2} alt="" />
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                        <div className="p-4">
                            <div className="p-6 rounded-lg">
                                <Image className="rounded w-auto object-cover object-center mb-6" src={browseCategories1} alt="content" />
                                <h2 className="text-lg text-[#015464] font-bold mb-1">Young Adult</h2>
                            </div>
                        </div>
                        <div className="p-4">
                            <div className="p-6 rounded-lg">
                                <Image className="rounded w-auto object-cover object-center mb-6" src={browseCategories2} alt="content" />
                                <h2 className="text-lg text-[#015464] font-bold mb-1">Romance</h2>
                            </div>
                        </div>
                        <div className="p-4">
                            <div className="p-6 rounded-lg">
                                <Image className="rounded w-auto object-cover object-center mb-6" src={browseCategories3} alt="content" />
                                <h2 className="text-lg text-[#015464] font-bold mb-1">Science & Fantasy</h2>
                            </div>
                        </div>
                        <div className="p-4">
                            <div className="p-6 rounded-lg">
                                <Image className="rounded w-auto object-cover object-center mb-6" src={browseCategories4} alt="content" />
                                <h2 className="text-lg text-[#015464] font-bold mb-1">Mystry & Crime</h2>
                            </div>
                        </div>
                        <div className="p-4">
                            <div className="p-6 rounded-lg">
                                <Image className="rounded w-auto object-cover object-center mb-6" src={browseCategories5} alt="content" />
                                <h2 className="text-lg text-[#015464] font-bold mb-1">Trillers & Horror</h2>
                            </div>
                        </div>
                    </div>
            ...
            <div className="mx-auto flex justify-between items-center sm:px-16 px-6 py-4 my-10">
