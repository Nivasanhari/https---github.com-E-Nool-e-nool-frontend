  ...
  return (
    <div className=" bg-white">
      ...
      <div className=" flex justify-between top-48 absolute ">
        <h1 className=" absolute ml-[500px] mt-14 text-[#015464] text-3xl font-extrabold">
          Have Any Questions
        </h1>
        ...
        <div className=" bg-[#015464] flex rounded-3xl h-[450px] w-[700px]">
          ...
          <form className=" mt-14 gap-4 flex-col  flex">
            ...
            <textarea
              ...
              rows="5"
            ></textarea>
            <button className=" text-white bg-[#7CC9B5] text-[11px] rounded-xl mt-5 p-2">
              send Message
            </button>
          </form>
        </div>
      ...
      <div className=" mt-44 flex">
        <div className="w-72 h-96 mt-[50px] ml-48 lg:mt-16 max-w-sm">
          <div className="bg-white shadow-2xl rounded-b-3xl pb-6 pr-8 justify-center flex">
            ...
            <div className=" text-start">
              <h2 className=" text-[#015464] text-2xl font-bold pt-6">
                Call Us
              </h2>
              <p className="text-center  text-[#14adad] font-bold">
                +91 1234567890
              </p>
              <p className="text-center  text-[#14adad] font-bold">
                +91 1234567890
        ...
        <div className="w-72 h-96 mt-[50px] ml-9 lg:mt-16 max-w-sm">
          ...
          <Image
            className=" absolute ml-[1150px] top-[1070px] left-24 w-28 "
            src={leaf2}
            alt="leaf2"
          />
        </div>
