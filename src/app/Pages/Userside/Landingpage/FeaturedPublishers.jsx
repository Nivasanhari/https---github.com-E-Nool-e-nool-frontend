          ...
          <div class="w-full md-px-24 relative  container px-5 py-24 mx-auto">
              <div class="flex flex-wrap w-full mb-10">
                  <div class="lg:w-1/2 w-full mb-6 lg:mb-0">
                      <h1 class="sm:text-3xl text-2xlads font-bold title-font mb-2 text-[#015464]">Featured Publishers</h1>
                      <div class="h-1 w-48 bg-[#0FBF61] opacity-20 rounded"></div>
                  </div>
                  <div class="lg:w-1/2 w-full mb-6 lg:mb-0 flex justify-end">
                      <button class=" text-white bg-[#015464] border-0 py-2 px-6 focus:outline-none w-28 h-10 rounded-[21px] text-sm "><h1 className="items-center">View all</h1></button>
                  </div>
              </div>
