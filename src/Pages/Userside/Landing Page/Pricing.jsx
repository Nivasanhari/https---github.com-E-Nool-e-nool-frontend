        ...
        <section className="container mx-auto  px-5 py-24 md:flex-row flex-col items-center mb-96">
            ...
            <div className="flex flex-col justify-between items-center lg:flex-row lg:items-start">
                ...
                <div className="w-80 h-96  mt-24 m-auto lg:mt-16 max-w-sm">
                    <img src="./pricing1.png" alt="" className="h-screen rounded-t-2xl shadow-2xl lg:w-full 2xl:w-80 2xl:h-96 object-cover" />
...
{/* <div className=" w-6 h-96flex-1 mt-8 p-8 order-2  bg-white shadow-xl rounded-3xl sm:w-96 lg:w-full lg:order-1 lg:rounded-r-none">
    <div className=" flex mb-7 pb-7  justify-center border-b border-gray-300">
        <img src="./Ellipse 25.png" alt="" className="z-10 rounded-3xl w-20 h-20" />
        <img src="./Path 330.png" alt="" className="z-5 rounded-3xl w-20 h-20" />
        <img src="./pricing1.png" alt="" className="z-0 rounded-3xl w-20 h-20" />
